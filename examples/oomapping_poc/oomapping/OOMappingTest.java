...
public class OOMappingTest extends TestCase {
  ...
  public void testMatch() {
    ...
    {{if (tom_is_sort_T1(subject)) {if (tom_is_fun_sym_f((( base.hand.types.T1 )subject))) { base.hand.types.T2  tomMatch1_2=tom_get_slot_f_s2((( base.hand.types.T1 )subject));if (tom_is_fun_sym_g(tomMatch1_2)) {
 
        assertEquals(tom_get_slot_f_s1((( base.hand.types.T1 )subject)),tom_make_f(tom_make_a(),tom_make_b()));
  ...
  public static class Print extends tom.library.sl.AbstractStrategyBasic {public Print() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  base.hand.types.T1  visit_T1( base.hand.types.T1  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_T1(tom__arg)) {

 System.out.println((( base.hand.types.T1 )tom__arg)/*+ " : " + getPosition()*/); }}}return _visit_T1(tom__arg,introspector);}@SuppressWarnings("unchecked")public  base.hand.types.T2  visit_T2( base.hand.types.T2  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_T2(tom__arg)) {


 System.out.println((( base.hand.types.T2 )tom__arg)/*+ " : " + getPosition()*/); }}}return _visit_T2(tom__arg,introspector);}@SuppressWarnings("unchecked")public  base.hand.types.T1  _visit_T1( base.hand.types.T1  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( base.hand.types.T1 )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  base.hand.types.T2  _visit_T2( base.hand.types.T2  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( base.hand.types.T2 )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_T1(v)) {return ((T)visit_T1((( base.hand.types.T1 )v),introspector));}if (tom_is_sort_T2(v)) {return ((T)visit_T2((( base.hand.types.T2 )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}public static class Rule extends tom.library.sl.AbstractStrategyBasic {public Rule() {super(tom_make_Fail());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  base.hand.types.T1  visit_T1( base.hand.types.T1  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_T1(tom__arg)) {if (tom_is_fun_sym_f((( base.hand.types.T1 )tom__arg))) {
        ...
        return tom_get_slot_f_s1((( base.hand.types.T1 )tom__arg));
      }}}}return _visit_T1(tom__arg,introspector);}@SuppressWarnings("unchecked")public  base.hand.types.T1  _visit_T1( base.hand.types.T1  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( base.hand.types.T1 )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_T1(v)) {return ((T)visit_T1((( base.hand.types.T1 )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_Rule() { return new Rule();}public static class Rule2 extends tom.library.sl.AbstractStrategyBasic {public Rule2() {super(tom_make_Fail());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  base.hand.types.T2  visit_T2( base.hand.types.T2  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_T2(tom__arg)) {if (tom_is_fun_sym_g((( base.hand.types.T2 )tom__arg))) {return tom_get_slot_g_s2((( base.hand.types.T2 )tom__arg));}}}}return _visit_T2(tom__arg,introspector);}@SuppressWarnings("unchecked")public  base.hand.types.T2  _visit_T2( base.hand.types.T2  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( base.hand.types.T2 )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_T2(v)) {return ((T)visit_T2((( base.hand.types.T2 )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}
  ...
  public void test_listMatchFirst() {
    ...
    {{if (tom_is_sort_ListT1(subject)) {if (tom_is_fun_sym_concT1((( java.util.List )subject))) {if (!(tom_is_empty_concT1_ListT1((( java.util.List )subject)))) {


        assertEquals(tom_get_head_concT1_ListT1((( java.util.List )subject)), tom_make_a());
        return;
      }}}}}
  ...
  public void test_listMatchLast() {
    ...
    {{if (tom_is_sort_ListT1(subject)) {if (tom_is_fun_sym_concT1((( java.util.List )subject))) { java.util.List  tomMatch7__end__4=(( java.util.List )subject);do {{if (!(tom_is_empty_concT1_ListT1(tomMatch7__end__4))) {if (tom_is_empty_concT1_ListT1(tom_get_tail_concT1_ListT1(tomMatch7__end__4))) {


        assertEquals(tom_get_head_concT1_ListT1(tomMatch7__end__4), tom_make_f(tom_make_a(),tom_make_g(tom_make_b())));
        return;
      }}if (tom_is_empty_concT1_ListT1(tomMatch7__end__4)) {tomMatch7__end__4=(( java.util.List )subject);} else {tomMatch7__end__4=tom_get_tail_concT1_ListT1(tomMatch7__end__4);}}} while(!(tom_equal_term_ListT1(tomMatch7__end__4, (( java.util.List )subject))));}}}}
  ...
  public void test_listMatchCount() {
    ...
    int i = 0;
    {{if (tom_is_sort_T2(subject)) {if (tom_is_fun_sym_h((( base.hand.types.T2 )subject))) { java.util.List  tomMatch8_1=tom_get_slot_h_ts((( base.hand.types.T2 )subject));if (tom_is_fun_sym_concT1(tomMatch8_1)) { java.util.List  tomMatch8__end__6=tomMatch8_1;do {{if (!(tom_is_empty_concT1_ListT1(tomMatch8__end__6))) {
  ...
  public void test_listMatchNonLinear() {
    ...
    {{if (tom_is_sort_T2(subject)) {if (tom_is_fun_sym_h((( base.hand.types.T2 )subject))) { java.util.List  tomMatch9_1=tom_get_slot_h_ts((( base.hand.types.T2 )subject));if (tom_is_fun_sym_concT1(tomMatch9_1)) { java.util.List  tomMatch9__end__6=tomMatch9_1;do {{if (!(tom_is_empty_concT1_ListT1(tomMatch9__end__6))) { base.hand.types.T1  tom_x=tom_get_head_concT1_ListT1(tomMatch9__end__6); java.util.List  tomMatch9_7=tom_get_tail_concT1_ListT1(tomMatch9__end__6); java.util.List  tomMatch9__end__10=tomMatch9_7;do {{if (!(tom_is_empty_concT1_ListT1(tomMatch9__end__10))) {if (tom_equal_term_T1(tom_x, tom_get_head_concT1_ListT1(tomMatch9__end__10))) {
  ...
  public void test_listMatchAny() {
    ...
    {{if (tom_is_sort_T2(subject)) {boolean tomMatch10_10= false ;if (tom_is_fun_sym_h((( base.hand.types.T2 )subject))) { java.util.List  tomMatch10_1=tom_get_slot_h_ts((( base.hand.types.T2 )subject));if (tom_is_fun_sym_concT1(tomMatch10_1)) { java.util.List  tomMatch10__end__6=tomMatch10_1;do {{if (!(tom_is_empty_concT1_ListT1(tomMatch10__end__6))) {if (tom_is_fun_sym_a(tom_get_head_concT1_ListT1(tomMatch10__end__6))) {tomMatch10_10= true ;}}if (tom_is_empty_concT1_ListT1(tomMatch10__end__6)) {tomMatch10__end__6=tomMatch10_1;} else {tomMatch10__end__6=tom_get_tail_concT1_ListT1(tomMatch10__end__6);}}} while(!(tom_equal_term_ListT1(tomMatch10__end__6, tomMatch10_1)));}}if (!(tomMatch10_10)) {
